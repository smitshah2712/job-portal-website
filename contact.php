...
<head>
	...
	<title>Jobnest.com - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Jobnest.com" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Resham Elegance, <br/> opp Samarthya Premium, Behind Bhaktinagar Society, <br/>Ahmedabad - 380005</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:sntechnologies@gmail.com">sntechnologies@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+918128534087">+918128534087</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobnest.com</h5>
											<p>Jobnest.com is a job portal, online job management system developed by SN Technologies for his project in January 2003.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Jobnest.com Contact</h5>
								
								<p>Address : A-404 Aroma Elegance, opp Bank of Baroda, SG Highway,
Ahmedabad - 380005</p>
								<p>Email : <a href="mailto:sntechnologies@gmail.com">sntechnologies@gmail.com</a></p>
								<p>Phone : <a href="tel:+918128534087">+918128534087</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Jobnest.com Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by SN Technologies</a></li>
								</ul>
